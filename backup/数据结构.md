...
- 左右旋为对称操作
1. 左旋
![IMG_20241004_232418](https://github.com/user-attachments/assets/dc92d6fc-803a-4441-9074-0e266db7d4f1)
```c++
// 左旋
    TreeNode* left_rotate(TreeNode* node) {
        TreeNode* child = node->right;
...
```
2. 右旋
![IMG_20241004_232428](https://github.com/user-attachments/assets/34016bd8-1c1c-4836-a3e4-9e4c425fac66)
```c++
// 右旋
    TreeNode* right_rotate(TreeNode* node) {
        TreeNode* child = node->left;
...
```
3. 先左旋后右旋
![IMG_20241004_232445](https://github.com/user-attachments/assets/2373bbe0-b5e0-4415-88e8-4a879a135e3f)
4. 先右旋后左旋
![IMG_20241004_232436](https://github.com/user-attachments/assets/2c0a126a-3fd9-4f5d-a597-aac555a40cf6)
